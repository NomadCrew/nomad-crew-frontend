...
/**
 * @atomic-level atom
 * @description Tag component for displaying status or categorization labels
 * @composition None - this is a base atom
 * @example
 * ```tsx
 * <Tag label="Active" variant="success" />
 * <Tag label="Warning" variant="warning" size="sm" />
 * <Tag label="Error" variant="error" startIcon={<Icon name="alert" />} />
 * ```
 */
export function Tag({
  label,
