...
import { useCurrentAppTheme } from '../../../theme/ThemeProvider';

export type ContainerVariant = 'screen' | 'content' | 'card' | 'section' | 'modal';
...
export interface ContainerProps {
   ...
   * @default 'default' for screen, 'surface' for others
   */
...
export const Container: React.FC<ContainerProps> = ({
  ...
  const getVariantStyles = (): ViewStyle => {
    const getBackgroundColor = (defaultColor: 'default' | 'surface' | 'elevated') => {
      ...
      return theme.colors.background[defaultColor];
    };
    ...
    switch (variant) {
      ...
      case 'modal':
        return {
          ...
          borderRadius: 16,
          backgroundColor: getBackgroundColor('elevated'),
