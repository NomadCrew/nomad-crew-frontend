...
// Track ongoing refresh token promise and unauthorized callback
...
// Configuration function that sets up interceptors
export function configureAPI() {
  ...
  // Response Interceptor for Normal Responses
    ...
    async (error) => {
      ...
      if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
          ...
          // Call unauthorized callback if exists
